...
# coastlines, states, and country boundaries
m.drawcoastlines()
m.drawstates()
m.drawcountries()
...
### mean number of days by scenario
# ntimes, ny, nx = shape(data)
# result = zeros((ny, nx), dtype = int)
# for i in xrange(ntimes):
#     result += data[i,:,:] >= 37.7777   # 32.2=90°F; 35=95°F; 37.777=100°F; 40=105°F; 43=110°F